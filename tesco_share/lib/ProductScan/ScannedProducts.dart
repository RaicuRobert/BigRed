...
class ScannedProductsViewState extends State<ScannedProductsView> {
  ...
  void _sendItems(){
    for(ProductScannedInfo productScannedInfo in scannedProducts)
     {
       Product product = new Product(productScannedInfo.apiData == null? productScannedInfo.barcode : productScannedInfo.apiData.description, productScannedInfo.category, productScannedInfo.quantity, productScannedInfo.barcode);
